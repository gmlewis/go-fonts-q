...
import (
  ...
  _ "github.com/gmlewis/go-fonts-q/fonts/qwigley_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from qwigley_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "qwigley_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
